...
export default function Grid() {
    ...
    function handleSave(index, data) {
        ...
        localStorage.setItem('InnerFit', JSON.stringify(newObj))
    ...
    useEffect(() => {
        ...
        let savedData = {}
        if (localStorage.getItem('InnerFit')) {
            savedData = JSON.parse(localStorage.getItem('InnerFit'))
        }
        ...
        <div className="training-plan-grid">
            {Object.keys(training_plan).map((workout, workoutIndex) => {
                ...
                if (workoutIndex === selectedWorkout) {
                    return (
                        <WorkoutCard savedWeights={savedWorkouts?.[workoutIndex]?.weights} handleSave={handleSave} handleComplete={handleComplete}
                         key={workoutIndex} trainingPlan={trainingPlan} type={type} workoutIndex={workoutIndex} icon={icon} dayNum={dayNum} />
                    )
                }
