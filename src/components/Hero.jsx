export default function Hero(){
    return(
        ...
        <ol>
            ...
            <li> Get fit, healthy,strong and toned</li>
            <li>Learn more about gym ,training and technique</li>
            <li>Become a workout girly💛</li>
        </ol>
        <h3>The Rules</h3>
        ...
        <p>This traing program uses a structure known as the <b>Bro</b> Splite and follows this rotation ⬇️</p>
